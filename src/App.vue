...
if(baseUrl.value == null || baseUrl.value == ''){
  localStorage.setItem('baseUrl', 'https://liebniztier.com/wp-content/uploads/45.jpg')
...
<template>
    <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
      ...
      <RouterLink to="/" class="flex items-center">
          <img src="https://liebniztier.com/wp-content/uploads/45.jpg" class="h-8 mr-3 rounded-full" alt="MehediPata Logo">
